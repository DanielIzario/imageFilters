...
imageFilters.printCanvas = function(selector, idata) {
...
imageFilters.filterImage = function(selector, filter, image) {
  var args = [this.getImage(image)];

  return this.printCanvas(selector, filter.apply(null, args));
};

imageFilters.redrawCanvas = function(selector, filter) {
  var ctx = selector.getContext('2d');
...
imageFilters.convolution = function(pixels, weights) {
...
imageFilters.histogram = function(image) {
  'use strict';
